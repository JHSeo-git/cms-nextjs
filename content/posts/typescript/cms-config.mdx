...
- name: 'posts'
  ...
  - label: Category
    ...
    collection: 'meta'
    file: 'categories'
    searchFields: - 'category._.name'
    displayFields: - 'category._.name'
    valueFields: 'category.\*.slug'
  - label: Tags
    label_singular: 'Tag'
    name: 'tags'
    widget: list
    ...
    collection: 'meta'
    file: 'tags'
    searchFields: - 'tags._.name'
    displayFields: - 'tags._.name'
